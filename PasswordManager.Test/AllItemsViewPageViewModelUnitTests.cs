...
{
	public class AllItemsViewPageViewModelUnitTests
	{
		...
		public void TestSearchQuery()
		{
			...
			*/
			...
			AllItemsPageViewModel allItemsPageViewModel = new AllItemsPageViewModel(ref vaultDataService, ref syncDataService, "Home");
			bool propertyChanged = false;

			allItemsPageViewModel.PropertyChanged += (s, e) =>
			{
				propertyChanged = true;
			};
			allItemsPageViewModel.SearchQuery = "Test Query";
		...
		public void TestSelectedItem()
		{
			...
			*/
			...
			allItemsPageViewModel.SiteSelectedItem = site;
			//Check the property changed event fired
			Assert.IsTrue(propertyChanged);
			/* End Reference */
		}
